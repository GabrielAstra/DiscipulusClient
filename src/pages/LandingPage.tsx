  ...
  const features = [
    {
      ...
      description: 'Conecte-se com professores verificados e experientes em todas as matérias'
    },
    {
      icon: BookOpen,
      title: 'Todas as Matérias',
      description: 'De exatas a humanas, encontre ajuda em qualquer matéria que precisar'
    },
    {
      icon: Star,
      title: 'Qualidade Garantida',
      description: 'Todos os professores são avaliados por estudantes como você'
    }
  ];

  const stats = [
    { number: '1000+', label: 'Professores Especialistas' },
    { number: '50+', label: 'Matérias' },
    { number: '10k+', label: 'Estudantes Satisfeitos' },
